...
//   const getUniqueCargoCode = async () => {
//     let newCargoCode = lastCargoCode + 1;
//     const usersSnapshot = await getDocs(collection(db, 'users'));

//     while (true) {
//       let isUnique = true;
//       usersSnapshot.forEach((doc) => {
//         if (parseInt(doc.data().cargoCode, 10) === newCargoCode) {
//           isUnique = false;
//         }
//       });
//       if (isUnique) break;
...
//     e.preventDefault();
//     try {
//       const newCargoCode = await getUniqueCargoCode();
